...
CXXFLAGS := $(CXXFLAGS) -I$(shell $(LLVM_CONFIG_BIN) --includedir) --std=c++17  -Wall -DVERSION=\"$(VERSION_STRING)\"
LDFLAGS := $(LDFLAGS) $(shell $(LLVM_CONFIG_BIN) --ldflags --system-libs --libs all)
